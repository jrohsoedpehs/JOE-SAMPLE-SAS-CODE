/*Macro for trt with 3 groups*/
/*The datasets need to be renamed as demo and demo1*/
/*trt cannot be missing in demo nor demo1*/
...
data &invar.t(drop=a b c _name_ );
	length _1 $12 cat $33;
	set &invar.t(rename=(_1=a _2=b _3=c));
	_1=a;  _2=b;  _3=c;
	select (_name_);
	when ('n') do; cat='N'; catn= 1; end;
	when ('mean') do; cat='Mean'; catn=2;end;
...
set tot&invar; 
order=&order;
percent=(count/(&tot1+&tot2+&tot3))*100;  
